...
__export(react_exports, {
  NuPIdentityContext: () => NuPIdentityContext,
  NuPIdentityProvider: () => NuPIdentityProvider,
  useAccessToken: () => useAccessToken,
  useHasAllPermissions: () => useHasAllPermissions,
  useHasAnyPermission: () => useHasAnyPermission,
  useHasPermission: () => useHasPermission,
  useIsAuthenticated: () => useIsAuthenticated,
  useNuPIdentity: () => useNuPIdentity,
...
var NuPIdentityContext = (0, import_react.createContext)(null);
...
function NuPIdentityProvider({
  ...
  const [endpoints, setEndpoints] = (0, import_react.useState)(null);
  const getEndpoints = (0, import_react.useCallback)(async () => {
  ...
  const fetchUserInfo = (0, import_react.useCallback)(async (token) => {
    try {
  ...
  const initializeSession = (0, import_react.useCallback)(async () => {
    try {
  ...
  const getAccessToken = (0, import_react.useCallback)(() => accessToken, [accessToken]);
  const getUserIdFromToken = (0, import_react.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NuPIdentityContext.Provider, { value: contextValue, children });
}
function useNuPIdentity() {
  const context = (0, import_react.useContext)(NuPIdentityContext);
  if (!context) {
